...
('Estrella Fugaz', 'restaurant', 'Vegan Restaurant', 'Upscale plant-based dining with locally-sourced organic ingredients and ocean views.', 'Beach road', 15.6665, -96.7342, 'Daily 8am-10pm', '$$$', '@estrellamazunte', NULL, ARRAY['vegan', 'organic', 'ocean-view', 'plastic-free'], true, true),
('La Mora', 'restaurant', 'Vegetarian Café', 'Cozy café serving breakfast, smoothie bowls, coffee, and light vegetarian meals.', 'Village center', 15.6660, -96.7345, 'Daily 7am-6pm', '$$', '@lamoramazunte', NULL, ARRAY['vegetarian', 'coffee', 'breakfast', 'wifi'], true, true),
('Siddhartha', 'restaurant', 'Health Food', 'Health-focused restaurant with vegan, vegetarian, and pescatarian options.', 'Main road', 15.6658, -96.7346, 'Daily 8am-9pm', '$$', '@siddharthamzt', NULL, ARRAY['healthy', 'vegan-options', 'fresh-juice'], false, true),
('Raw & Wild Juice Bar', 'restaurant', 'Juice Bar', 'Fresh cold-pressed juices, smoothies, and raw desserts. All organic!', 'Beach entrance', 15.6656, -96.7344, 'Daily 7am-7pm', '$', '@rawwildmzt', NULL, ARRAY['juice', 'smoothies', 'raw', 'organic', 'vegan'], true, false),
('Toro Güero', 'restaurant', 'Mexican Fusion', 'Creative Mexican cuisine with vegetarian and vegan options. Great cocktails!', 'Main beach road', 15.6662, -96.7348, 'Tue-Sun 1pm-11pm', '$$', '@toroguero', NULL, ARRAY['mexican', 'cocktails', 'vegan-options'], false, true),
('Armadillo Café', 'restaurant', 'International Café', 'International menu, great coffee, and co-working friendly atmosphere.', 'Village square', 15.6664, -96.7343, 'Mon-Sat 8am-8pm', '$$', '@armadillomzt', NULL, ARRAY['coffee', 'wifi', 'co-working', 'breakfast'], false, false);
